    ...
    <div class="container">
        <div class="row">
                <form action="" method="post" name="myform" onsubmit="return myfun()">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 m-5 text-center">
                    <label class="lab lab1">Email <input type="text" name="email" id="email" value="" required><br><span id="mess"> </span></label>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 m-5 text-center">
                    <label class="lab">Contact <input type="contact" name="contact" id="phone" value="" required><br><span id="message"> </span></label>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 m-5 text-center">
